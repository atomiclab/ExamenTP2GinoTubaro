...
export const usuariosService = {
	async getAllUsuarios() {
		try {
			...
			if (error.code === "ENOENT") {
				return { success: false, error: "Base de datos no encontrada", code: "DB_NOT_FOUND" };
			}
			return { success: false, error: "Error al leer usuarios", details: error.message };
		}
	},
	...
	async getUsuarioById(id) {
		try {
			...
			return { success: false, error: "Error al buscar usuario", details: error.message };
		}
	},
	...
	async deleteUsuario(id) {
		try {
			...
			return { success: false, error: "Error al eliminar usuario", details: error.message };
		}
	},
	...
	async saveUsuarios(usuarios) {
		try {
			...
			return { success: false, error: "Error al guardar usuarios", details: error.message };
		}
	}
};